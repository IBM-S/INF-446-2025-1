...
public:
	...
	void GenerateSimpleFeasible_Random(double num_AEDs, double nums_Preinstalados);
	void GenerateRandomFullRange(int nums_AEDs_instalar);
	void GenerateSimpleFeasible_Reloc_BalancedQuantity(double presupuesto_disponible, double split_pct);
	//void GenerateGreedyFeasibleSolution(int num_total, double factor);
